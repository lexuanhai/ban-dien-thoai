...
namespace TECH.Migrations
{
    ...
    [Migration("20221123111834_UpdateDatabaseTableProduct")]
    partial class UpdateDatabaseTableProduct
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TECH.Data.DatabaseEntity.ColorImages", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("product_quantities_id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("product_quantities_id");

                    b.ToTable("color_images");
                });
            ...
            modelBuilder.Entity("TECH.Data.DatabaseEntity.Manufacturer", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TECH.Data.DatabaseEntity.ProductQuantity", b =>
                {
                    ...
                    b.Property<decimal?>("priceimprot")
                        .HasColumnType("decimal(18,0)");
            ...
            modelBuilder.Entity("TECH.Data.DatabaseEntity.ColorImages", b =>
                {
                    ...
                    b.HasOne("TECH.Data.DatabaseEntity.ProductQuantity", "ProductQuantity")
                        .WithMany()
                        .HasForeignKey("product_quantities_id");
            ...
            modelBuilder.Entity("TECH.Data.DatabaseEntity.Products", b =>
                {
                    ...
                    b.HasOne("TECH.Data.DatabaseEntity.Manufacturer", "Manufacturer")
                        .WithMany()
